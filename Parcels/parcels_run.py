...
Parcels run script for CLASS modelling workshop 2024
"""
...
tlon=31 #target lon - must be a number between -180 and 180 
tlat=-35  #target lat - must be a number between -90 and 90 
tdepth=10 #target depth - must be a number between 2 and 5500 
runtime=5*365 #in days - must be less than 3650 days, 10 years=365*10 - align the time you want to run for with the yearstart and year end below
yearstart=2005 #year to start simulation - must be between 2005 and 2014
yearend=2010 #year you want simulation to end - must be between 2005 and 2014
...
outfile_name='output_5yrs3' #choose a file name - do not includes spaces
